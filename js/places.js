...
(function () {
  ...
  const PLACES = [
    ...
    P('Napels', 'Naples', ['napoli', 'bedolven stad'], [40.8518, 14.2681], 10),
    P('Helsinki', 'Helsinki', ['finland', 'suomi', 'noordelijkste land eu', 'meest noordelijke land eu'], [60.1699, 24.9384], 9),
    ...
    P('Wenen', 'Vienna', ['vienna', 'wien', 'oostenrijk', 'austria', 'stephansdom', 'hoofdstad van de muziek', 'muziekstad', 'mozart'], [48.2082, 16.3738], 10),
    P('Porto', 'Porto', ['oporto', 'port', 'portwijn', 'port wine', 'sandeman'], [41.1579, -8.6291], 10),
    P('Zwarte Zee', 'Black Sea', ['black sea', 'zwarte zee', 'krim', 'crimea'], [43.4, 34.3], 5),
    P('Tsjernobyl', 'Chernobyl', ['chernobyl', 'tsjernobil', 'pripjat', 'pripyat', 'oekraine', 'ukraine', 'kerngevaar', 'kernramp', 'kerncentrale'], [51.3890, 30.0990], 10),
    ...
    P('Warschau', 'Warsaw', ['warsaw', 'warszawa', 'polen', 'poland', 'chopin', 'thuisland chopin'], [52.2297, 21.0122], 9),
    P('Edinburgh', 'Edinburgh', ['schotland', 'scotland', 'edinburgh castle', 'kilt', 'schot'], [55.9533, -3.1883], 9),
