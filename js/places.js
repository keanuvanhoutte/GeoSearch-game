...
(function () {
  ...
  const PLACES = [
    ...
    P('Stockholm', 'Stockholm', [], [59.3293, 18.0686], 9),
    ...
    P('Baikalmeer', 'Lake Baikal', ['baikal', 'meer baikal', 'baikalmeer', 'baikal lake'], [53.5, 108.2], 6),
    ...
    P('Chicago', 'Chicago', ['cloud gate', 'the bean'], [41.8781, -87.6298], 10),
    P('Great Blue Hole', 'Great Blue Hole', ['blue hole', 'belize'], [17.3159, -87.5347], 11),
    P('Aconcagua', 'Aconcagua', [], [-32.6532, -70.0109], 10),
    P('Bogotá', 'Bogotá', ['bogota'], [4.7110, -74.0721], 9),
    P('Colombia', 'Colombia', [], [4.6, -74.3], 5),
    P('Monding van de Amazone', 'Mouth of the Amazon', ['amazonemonding', 'belem', 'amazone'], [-1.4558, -48.5039], 7),
    P('Machu Picchu', 'Machu Picchu', ['machupicchu'], [-13.1631, -72.5450], 12),
    ...
    P('Gobiwoestijn', 'Gobi Desert', ['gobi', 'gobi woestijn', 'mongolie', 'mongolia'], [43.5, 103.5], 5),
    ...
    P('Dubai', 'Dubai', ['burj khalifa', 'emiraten'], [25.1972, 55.2744], 10),
    P('Malediven', 'Maldives', ['maldiven', 'maldives', 'male'], [3.2028, 73.2207], 7),
    P('Seychellen', 'Seychelles', ['seychelles'], [-4.6796, 55.4920], 8),
    P('Kilimanjaro', 'Kilimanjaro', ['kilimandjaro', 'tanzania'], [-3.0674, 37.3556], 9),
    P('Mekka', 'Mecca', ['mecca', 'makkah', 'kaaba'], [21.4225, 39.8262], 11),
