...
window.GeoRiddlesBlue = [
  ...
  },
  {
    ...
    targets: [
      { key: 'madrid', name: { nl: 'Madrid (Spanje)', en: 'Madrid (Spain)' },
        ...
        hint: {
          nl: 'Een stier onder een rood-gele vlag: het land dat het grootste deel van het schiereiland in het zuidwesten beslaat. Klik midden in dat land, op de hoofdstad.',
          en: 'A bull under a red-and-yellow flag: the country that fills most of the peninsula in the south-west. Click the middle of that country, on its capital.',
        } },
  ...
  },
  {
    ...
    position: 4,
    targets: [
      { key: 'lhasa', name: { nl: 'Lhasa (Tibet)', en: 'Lhasa (Tibet)' },
        point: [29.6570, 91.1170], zones: [[29.6570, 91.1170, 400]],
        hint: {
          nl: 'Een reusachtig wit-rood paleis in trappen tegen een heuvel, met gebedsvlaggetjes ervoor. Het staat in de hoofdstad van Tibet, hoog op het dak van de wereld.',
          en: 'An enormous white-and-red palace stepped up against a hill, with prayer flags in front. It stands in the capital of Tibet, high on the roof of the world.',
        } },
      { key: 'fuji', name: { nl: 'Mount Fuji (Japan)', en: 'Mount Fuji (Japan)' },
        point: [35.3606, 138.7274], zones: [[35.3606, 138.7274, 400]],
        hint: {
          nl: 'Een volmaakt gevormde vulkaan met een besneeuwde top, achter een rode poort. De heilige berg van Japan.',
          en: 'A perfectly shaped volcano with a snowy top, behind a red gate. The sacred mountain of Japan.',
        } },
      { key: 'baikal', name: { nl: 'Baikalmeer (Siberië)', en: 'Lake Baikal (Siberia)' },
        ...
        hint: {
          nl: 'Het diepste meer ter wereld, een lange sikkel tussen de bergen van Zuid-Siberië. In de winter ligt er dik ijs op, met zeehonden erop.',
          en: 'The deepest lake in the world, a long crescent between the mountains of southern Siberia. In winter thick ice covers it, with seals on top.',
        } },
      ...
      { key: 'borobudur', name: { nl: 'Borobudur (Java)', en: 'Borobudur (Java)' },
        point: [-7.6079, 110.2038], zones: [[-7.6079, 110.2038, 400]],
        hint: {
          nl: 'Een reusachtige trappentempel met klokvormige torentjes, tussen de vulkanen op het eiland Java in Indonesië.',
          en: 'An enormous stepped temple with bell-shaped little towers, among the volcanoes on the island of Java in Indonesia.',
        } },
