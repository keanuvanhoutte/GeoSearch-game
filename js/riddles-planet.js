  ...
  },
  {
    ...
    targets: [
      ...
      { key: 'oslo', name: { nl: 'Oslo (Noorwegen)', en: 'Oslo (Norway)' },
        ...
        hint: {
          nl: 'De hoofdstad van het noordelijkste land van Europa: het land van de fjorden en de Noordkaap, waar de zon ’s zomers niet ondergaat. Het hoort niet bij de EU.',
          en: 'The capital of the northernmost country in Europe: the land of the fjords and the North Cape, where the sun does not set in summer. It is not in the EU.',
        } },
